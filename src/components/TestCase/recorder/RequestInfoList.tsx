...
//   return (
//     <Tag style={{ color: fontColor, borderRadius: 12, padding: '0 12px' }} color={color}>
//       {text}
//     </Tag>
//   );
// };
...
// };
//
// const RequestInfoList: React.FC<RequestInfoProps> = ({
//   dataSource,
//   dispatch,
//   loading,
//   ...restProps
...
//       render: (md) => (
//         <MethodTag fontColor={tagColor(md).fontColor} color={tagColor(md).color} text={md} />
//       ),
//     },
//     {
//       title: '请求headers',
...
//       rowKey={(record) => record[restProps.rowKey]}
//       loading={loading}
//       locale={{ emptyText: <NoRecord desc={restProps.emptyText} height={150} /> }}
//     />
//   );
// };
//
...
const RequestInfoList: React.FC<RequestInfoProps> = ({dataSource, dispatch, loading, ...restProps}) => {
  ...
  const columns: ColumnsType<RequestInfo> = [
    ...
    },
    {
      key: 'ops',
      title: '操作',
      render: (_, record,index) => <Tooltip title="点击可删除录制数据(不推荐)"><DeleteTwoTone twoToneColor="#F56C6C" onClick={() => {

...
//     const temp = caseList.filter(item => item.data_name.indexOf(value) > -1 ||
//     item.case_name.indexOf(value) > -1);
...
//             <Col span={18}/>
//             <Col span={6}>
//               <Input prefix={<SearchOutlined/>} placeholder="请输入用例名称"
//                      className="borderSearch" onPressEnter={onSearchCase}/>
//             </Col>
//           </Row>
//           <Row gutter={[8, 8]}>
//             <Col span={24}>

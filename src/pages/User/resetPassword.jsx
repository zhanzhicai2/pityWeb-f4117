  ...
  const onSubmit = async () => {
    ...
    if (res) {
      ...
      notification.success({
        ...
        description: (
          <span>
            {/*将在3秒后进入登录界面，点击<a href="https://pity.fun/#/user/login">此处</a>*/}
            将在3秒后进入登录界面，点击<a href="http://127.0.0.1:8010/#/user/login">此处</a>
            可跳转至登录页面
          </span>
        ),
      });
  ...
  return (
    <div className={styles.main}>
      ...
      <Form {...CONFIG.LAYOUT} style={{ marginTop: 12 }} form={form}>
        ...
        >
          <Button disabled={disable} block type="primary" onClick={onSubmit}>
            确认
          </Button>
        </Form.Item>
      </Form>
